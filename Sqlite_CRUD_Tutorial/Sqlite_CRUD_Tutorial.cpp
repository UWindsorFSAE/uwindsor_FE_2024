...
//not yet configured for raspberry pi beacause its giving me problems
// Several extra files have been added to resource file to facilitate with the program
// Program presumably dosent run without them
...
const char* DBDir = "C:\\Users\\plays\\Downloads\\MigrationTesting\\TestDatabase\\LoggedData.db"; // change this directory to where ever you want the database to be created/saved
